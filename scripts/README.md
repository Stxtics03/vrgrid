...
frame -- `timing_table.py`, `ablation_table.py`, `ghost_removal_figure.py` --
take `--seq <NN>` to run against real SemanticKITTI instead of a synthetic
sweep. Set `$VRGRID_DATA_ROOT`; see `data/README.md` for the layout.
